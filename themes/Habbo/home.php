	...
	<div style="    width: 500px; margin-left: 0px;" class="columright">
		<div style = "" class="box">
			...
			<div class="mainBox" style="float;left">
				<div id="column" style="    width: 460px;height: 400px;background: url('<?php echo H. $config['skin']; ?>/assets/images/photo.png') no-repeat center;background-color: #FFF;">
<br><br><br><br>
			...
			<div class="mainBox" style="float;left">
				<?php
					...
					if (!$stmt->RowCount() == 0)
					{
						...
						{
							echo"<img src=\"".$config['badgeURL']."".filter($badge["badge_id"]).".GIF\" style='padding-left: 10px;'>";
						}
					}
					else
					{
