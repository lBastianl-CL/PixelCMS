...
?>
   <link type="text/css" rel="stylesheet" href="<?php echo H. $config['skin']; ?>/assets/css/materialize.min.css"  media="screen,projection"/>
	  <link type="text/css" rel="stylesheet" href="<?php echo H. $config['skin']; ?>/assets/css/index.css?3243"  media="screen,projection"/>
...
<nav class="nav-extended" style="background-color: rgba(167, 217, 242, 0.6);">
	...
	<font color="white"> ...<a href="/login"><div class="btn" style="margin-left:6px;background:#077c2c;border-bottom:2px solid rgba(0,0,0,.4);margin-top:-4px;margin-right:-17px;font-family: sans-serif;"><b><?php echo $lang["Rlogin"]?></b></div></font>
			</div>
      <a><div class="logo">
...
<input type="submit" class="btn" value="<?php echo $lang['Rbutton']; ?>" name="register" style="background:#07547c;border-bottom:2px solid rgba(0,0,0,.4);width:304px;margin-top: -25px;margin-left:17px;">      </form></div>
