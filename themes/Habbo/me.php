...
<div class="center">
	<div class="columleft">
		<div class="boxuser">
			...
			<a href="client">
<button style="margin-left: 10px;background-color: #137d40;border-bottom: 3px solid #183c27;color: #fff;width: 96.7%;margin-top: 10px;border-top: none;border-left: none;border-right: none;border-radius: 10px 10px 10px 10px;padding: 14px;font-size: 16px;">Entrar al hotel</button>
</a>		</div>
