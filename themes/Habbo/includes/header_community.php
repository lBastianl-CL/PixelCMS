...
<nav style="margin-top: 55px;padding: 0px 70px;width: auto;height: auto !important;background: rgb(255, 255, 255);margin-left: 190px;border-radius: 5px;border-bottom: 2px solid #212121;">
      ...
      <ul class="list--reset list--inline" style="margin-left: -60px;"> 
        <li><a href="/community" class="mobileHide" style=" color: #222; "><?= $lang["Ncommunity"] ?></a></li>
        <li><a href="/online" class="mobileHide" style=" color: #222; "><?= $lang["Nonline"] ?> <?= $config['hotelName'] ?>'s</a></li>
        <li><a href="/staffs" class="mobileHide" style=" color: #222; "><?= $lang["Nstaff"] ?></a></li>
        <li><a href="/alfas" class="mobileHide" style=" color: #222; "><?= $lang["NAlfas"] ?></a></li>
