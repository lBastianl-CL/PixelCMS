...
<div class="nav-wrapper" style=" height: 250px !important; background: url(<?php echo H. $config['skin']; ?>/assets/images/headerhallowen.png);background-position: -20px; border-bottom: 2px solid #eee;margin-top: -8px; ">	<div class="onlineBox" style="top:60px;margin-left: -60px;margin-top: 38px;"><div class="arrow"></div>
	...
	<font color="white"> <b>...<a href="/register"><div class="btn" style="margin-left:6px;background:#5D8E6D;border-bottom:2px solid rgba(0,0,0,.4);margin-top:-4px;margin-right:-17px;font-family: sans-serif;"><b><?php echo $lang["Iregister"]?></b></div></font>
			</div>
 ...
 <div class="row">
    <form class="col s12" method="POST">
	  ...
	  <small style="margin-left:30px"><?php echo $lang["Iusername"] ?></small>
		...
		<input type="submit" name="login" class="btn" value="<?php echo $lang["Ibutton"]?>" style="float:right;background:#222;border-bottom:2px solid rgba(0,0,0,.4);width:auto;margin-top:-11px;margin-right:12px;"></input>
	  </div>
...
<div class="contentBox" style="background:url(<?php echo H. $config['skin']; ?>/assets/images/headerhallowen.png) 0px;padding:0;border: 2px solid #f3f3f3;padding-bottom:7px;">
<h5 style="color:white;padding:8px;"><?php echo $lang["Iregister2"]?></h5>
<a href="/register"><div class="btn" style="background:#794d64;border-bottom:2px solid rgba(0,0,0,.4);width:250px;margin-left:14px;"><?php echo $lang["Iregister3"]?></div></a>
</div>
</div>
