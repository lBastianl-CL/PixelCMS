...
.clouds {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/clouds.png");
  width: 643px;
  height: 304px;
  position: absolute;
  left: 134px;
...
.the404 {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/404.png");
  width: 352px;
  height: 142px;
  position: absolute;
  left: 242px;
...
.monkey {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/monkeya.png");
  width: 169px;
  height: 140px;
  position: absolute;
  left: 31px;
...
.monkey-eye-l {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/monkey-eye-l.png");
  width: 6px;
  height: 6px;
  position: absolute;
  left: 127px;
...
.monkey-eye-r {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/monkey-eye-r.png");
  width: 5px;
  height: 5px;
  position: absolute;
  left: 141px;
...
.moon {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/moon.png");
  width: 94px;
  height: 94px;
  position: absolute;
  left: 564px;
...
.platform {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/platform.png");
  width: 163px;
  height: 79px;
  position: absolute;
  left: 58px;
...
.star1 {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/star1.png");
  width: 37px;
  height: 37px;
  position: absolute;
  left: 66px;
...
.star2 {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/star2.png");
  width: 37px;
  height: 37px;
  position: absolute;
  left: 446px;
...
.star3 {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/star3.png");
  width: 23px;
  height: 21px;
  position: relative;
  left: 680px;
...
.star4 {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/star4.png");
  width: 23px;
  height: 21px;
  position: absolute;
  left: 232px;
...
.swirl {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/swirl.png");
  width: 72px;
  height: 72px;
  position: absolute;
  left: 734px;
...
.sword {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/sworda.png");
  width: 100px;
  height: 78px;
  position: absolute;
  left: 335px;
...
.sword-shadow {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/sword-shadow.png");
  width: 22px;
  height: 45px;
  position: absolute;
  left: 28px;
...
.tetris {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/tetris.png");
  width: 96px;
  height: 96px;
  position: absolute;
  left: 459px;
...
.triforce {
  background: url("<?php echo H. $config['skin']; ?>/assets/images/404/triforce.png");
  width: 76px;
  height: 61px;
  position: absolute;
  left: 130px;
