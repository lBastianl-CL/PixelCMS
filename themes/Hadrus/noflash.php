...
<head>
    ...
    <link rel="stylesheet" href="/themes/<?= $config['skin']; ?>/resources/css/client.css?<?=$hotel['cache']; ?>" type="text/css">
...
<div id="flash-container" style="visibility: visible;">
        	<div id="content" style="display: block;"> 
				...
				<a href="//www.adobe.com/go/getflashplayer">
					<div class="flashImage"><img src="/themes/<?= $config['skin']; ?>/resources/images/frank.gif"></div>
				...
				<td>
				<a href="#">
						<img src="/themes/<?= $config['skin']; ?>/resources/images/windows.png" width="100px" style=" cursor: pointer; ">
				</a>
				</td>
				...
				<td width="50px"></td>
				<td><a href="#"> <img src="/themes/<?= $config['skin']; ?>/resources/images/mac.png" width="100px" style=" cursor: pointer; "></a></td>
