...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo H. $config['skin']; ?>/assets/images/favicon.ico"/>
<link rel="author" href="<?= $config['hotelUrl'] ?>">
<link rel="publisher" href="<?= $config['hotelUrl'] ?>">
<link rel="canonical" href="<?= $config['hotelUrl'] ?>">
<meta property="og:type" content="Juego">
<meta name="generator" content="<?= $config['hotelUrl'] ?>">
...
<meta property="og:image" content="<?= $config['hotelUrl'] ?><?php echo H. $config['skin']; ?>/assets/images/ogimg.png">
<meta property="og:url" content="<?= $config['hotelUrl'] ?>">
<meta property="og:site_name" content="Hotel - <?= $config['hotelName'] ?> - ¡Crea tu personaje, construye tu habitación, conversa y haz nuevos amigos!"/>
